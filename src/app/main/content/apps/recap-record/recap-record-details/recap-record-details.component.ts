...
@Component({
  selector: 'app-recap-record-details',
  templateUrl: './recap-record-details.component.html',
  styleUrls: ['./recap-record-details.component.scss']
})
export class RecapRecordDetailComponent implements OnInit {
	rows: any;
	member_id: any;
	franchise_id: any;
  recap_id:any
