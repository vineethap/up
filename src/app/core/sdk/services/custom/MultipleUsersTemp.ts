...
/**
 * Api services for the `MultipleUsersTemp` model.
 */
@Injectable()
export class MultipleUsersTempApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id MultipleUsersTemp id
   *
   ...
   * This usually means the response is a `MultipleUsersTemp` object.)
   * </em>
   */
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/:id/accessTokens/:fk";
  ...
  /**
   * Queries accessTokens of MultipleUsersTemp.
   *
   * @param {any} id MultipleUsersTemp id
   *
   * @param {object} filter 
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts accessTokens of MultipleUsersTemp.
   *
   * @param {any} id MultipleUsersTemp id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public changePassword(oldPassword: any, newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/change-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
  ...
  public setPassword(newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/reset-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        newPassword: newPassword
   ...
   * </em>
   */
  public createMultipleUser(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MultipleUsersTemps/createMultipleUser";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.MultipleUsersTemp#getCurrent
   * @methodOf sdk.MultipleUsersTemp
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/MultipleUsersTemps" + "/:id";
   ...
   * call to {@link sdk.MultipleUsersTemp#login} or
   * {@link sdk.MultipleUsersTemp#getCurrent}. Return null when there
   ...
   * call to {@link sdk.MultipleUsersTemp#login}
   *
  ...
  /**
   * @name sdk.MultipleUsersTemp#isAuthenticated
   *
  ...
  /**
   * @name sdk.MultipleUsersTemp#getCurrentId
   *
